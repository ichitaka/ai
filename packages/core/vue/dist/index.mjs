...
var toolExecutionMessageStreamPart = {
  code: "9",
...
async function parseComplexResponse({
  ...
  for await (const { type, value } of readDataStream(reader, {
    ...
    const merged = [functionCallMessage, toolCallMessage, toolExecutionMessage, responseMessage].filter(Boolean).map((message) => ({
